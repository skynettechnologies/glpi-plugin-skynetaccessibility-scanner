...
<link href="css/scanning-and-monitoring-app.css" rel="stylesheet">
                                                                    ...
                                                                    <div class="status-card">
                                                                        ...
                                                                        <?php if (($data['url_scan_status'] ?? 0) < 2): ?>
                                                                            <span class="status-value status-inactive">
                                                                                <img src="css/Image/not-shared.svg"
                                                                                    alt=""
                                                                                    title="Not Started">
                                                                                Not Started
                                                                            </span>
                                                                        ...
                                                                        <?php elseif (($data['scan_status'] ?? 0) == 3): ?>
                                                                            <span class="status-value status-active">
                                                                                <?php echo $data['total_scan_pages'] ?? 0; ?> <br>Pages
                                                                                <?php
                                                                                    ...
                                                                                    <div class="tier"
                                                                                        ...
                                                                                        <div class="pricing-top">
                                                                                            <div class="pricing-header">
                                                                                                <div class="icon-circle">
                                                                                                    <?php if ($index == 0): ?>
                                                                                                        <img src="css/Image/diamond.svg" alt="" height="20" width="20">
                                                                                                    <?php elseif ($index == 1): ?>
                                                                                                        <img src="css/Image/pentagon.svg" alt="" height="20" width="20">
                                                                                                    <?php elseif ($index == 2): ?>
                                                                                                        <img src="css/Image/hexagon.svg" alt="" height="20" width="20">
                                                                                                    <?php elseif ($index == 3): ?>
                                                                                                        <img src="css/Image/hexagon.svg" alt="" height="20" width="20">
                                                                                                    <?php endif; ?>
                                                                                                </div>
                                                                                        ...
                                                                                        ?>
                                                                                        <button
                                                                                            class="upgrade-btn<?= (!$is_expired && isset($data['final_price']) && $data['final_price'] == $plan['monthly_price']) ? ' cancel-btnn' : '' ?>"
                                                                                            data-action="<?= $is_expired ? 'upgrade' : (isset($data['final_price']) && $data['final_price'] == $plan['monthly_price'] ? 'cancel' : 'upgrade') ?>"
                                                                                            onclick="handleUpgradeClick('<?= $plan['id'] ?>', this.dataset.action, 'M')">
                                                                                            <?= $is_expired ? 'upgrade' : (isset($data['final_price']) && $data['final_price'] == $plan['monthly_price'] ? 'cancel' : 'upgrade') ?>
                                                                                        </button>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const endDateStr = "<?= $data['end_date'] ?>"; // format: YYYY-MM-DD
