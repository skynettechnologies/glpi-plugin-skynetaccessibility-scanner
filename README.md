# SkynetAccessibility Scanner: GLPI Plugin
...
1. Download the latest release of `skynetaccessibilityscanner.zip`
2. Extract the archive into the GLPI plugins directory:
...
3. Log in to GLPI as Super-Admin.
4. Go to: Setup → Plugins.
5. Click **Install** next to "Skynet Accessibility Scanner".
6. After installation, click **Enable**.
7. Click the **Configure** icon to manage settings.

## Live Demo
https://glpi.skynettechnologies.us/
